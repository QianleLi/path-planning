...
#include "../include/JPS_searcher.h"
...
void pathFinding(const Vector3d start_pt, const Vector3d target_pt)
{
    ...
    //_use_jps = 0 -> Do not use JPS  置0不用JPS
    //_use_jps = 1 -> Use JPS  置1用JPS
...
int main(int argc, char** argv)
{
    ...
    //定义了结构体JPSPathFinder变量_jps_path_finder，该结构体存储、实现了JPS路径规划所需的所有信息和功能
